...
public class AccountsPage {
	...
	public AccountsPage approve_RepeatingInvoice() {
		driver.findElement(
				By.xpath("//tbody/tr//input[@name='selectedInvoices']"))
				.click();
		driver.findElement(By.xpath("//span[contains(text(),'Approve')]"))
				.click();
		try {
	...
	public boolean isInvoiceApproved() {
		...
		return driver.findElement(
				By.xpath("//tbody/tr/td[contains(text(),'Approved')]"))
				.isDisplayed();
	}
	...
	public boolean isInvoiceDeleted() {
		...
		return driver
				.findElement(By.xpath("//div[contains(@class,'document')]"))
				.getText().contains("There are no items to display.");
	}
