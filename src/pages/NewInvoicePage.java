...
public class NewInvoicePage {
	...
	public NewInvoicePage input_PaidToField(String paidToValue) {
		driver.findElement(By.xpath("//input[contains(@id,'PaidToName')]")).sendKeys(paidToValue);
		try {
	...
	public NewInvoicePage input_Reference() {
		driver.findElement(By.xpath("//div[@class='controls']/input[contains(@id,'Reference')]")).sendKeys("[Week]");
		return this;
	}
	
	public NewInvoicePage input_Item(String item) {
		driver.findElement(By.xpath("//div[contains(@class,'x-grid3-col-colPriceList')]")).click();
		driver.findElement(By.xpath("//div[contains(@class,'x-small-editor')]//input")).sendKeys(item);
		try {
			TestNGThread.sleep(2000);
			driver.findElement(By.xpath("//div[contains(@class,'x-combo-list-item')]")).click();
		} catch (InterruptedException e) {
			e.printStackTrace();
		}
		return this;
